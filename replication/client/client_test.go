...
func waitForShutdown(t *testing.T, mockManager *mocks.MockManagerInterface, replicator Replicator) {
...
func TestGetBasicTestSetup(t *testing.T) {
	...
	// Wait for shutdown
	waitForShutdown(t, mockManager, replicator)
}
